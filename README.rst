...
.. list-table::
    ...
    * - Latest Build
      - |github-actions|
    * - Source
      - `github.com/autumnjolitz/distroless-python <https://github.com/autumnjolitz/distroless-python>`_
    * - Issues
      - `github.com/autumnjolitz/distroless-python/issues <https://github.com/autumnjolitz/distroless-python/issues>`_
    * - DockerHub
      - `autumnjolitz/distroless-python <https://hub.docker.com/r/autumnjolitz/distroless-python>`_
